...
if("TRUE" STREQUAL "TRUE")
  set(localization_SOURCE_PREFIX /home/pi/edukit_bot_ws/src/localization)
  set(localization_DEVEL_PREFIX /home/pi/edukit_bot_ws/devel)
  ...
  set(localization_INSTALL_PREFIX /home/pi/edukit_bot_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'localization' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/edukit_bot_ws/src/localization/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT localization_NUM_DUMMY_TARGETS)
      set(localization_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::localization::wrapped-linker-option${localization_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR localization_NUM_DUMMY_TARGETS "${localization_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::localization::wrapped-linker-option${localization_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND localization_LIBRARIES "${interface_target_name}")
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(localization_EXPORTED_TARGETS ${${localization_dep}_EXPORTED_TARGETS})
endforeach()
