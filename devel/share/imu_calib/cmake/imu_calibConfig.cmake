...
if("TRUE" STREQUAL "TRUE")
  set(imu_calib_SOURCE_PREFIX /home/pi/edukit_bot_ws/src/imu_calib)
...
if(NOT "/home/pi/edukit_bot_ws/src/imu_calib/include;/usr/include/eigen3 " STREQUAL " ")
  set(imu_calib_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/edukit_bot_ws/src/imu_calib/include;/usr/include/eigen3")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_calib' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/edukit_bot_ws/src/imu_calib/${idir}'.  ${_report}")
    endif()
