...
if("TRUE" STREQUAL "TRUE")
  set(steer_drive_controller_SOURCE_PREFIX /home/pi/edukit_bot_ws/src/steer_drive_ros/steer_drive_controller)
  set(steer_drive_controller_DEVEL_PREFIX /home/pi/edukit_bot_ws/devel)
  ...
  set(steer_drive_controller_INSTALL_PREFIX /home/pi/edukit_bot_ws/install)
...
if(NOT "/home/pi/edukit_bot_ws/src/steer_drive_ros/steer_drive_controller/include " STREQUAL " ")
  set(steer_drive_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/edukit_bot_ws/src/steer_drive_ros/steer_drive_controller/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'steer_drive_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/edukit_bot_ws/src/steer_drive_ros/steer_drive_controller/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(steer_drive_controller_EXPORTED_TARGETS ${${steer_drive_controller_dep}_EXPORTED_TARGETS})
endforeach()
